...
- 目標變數分佈圖：`outputs/anxiety_level_distribution.png`
...
- 預測圖檔案：`outputs/prediction_plot_with_ci.png`
...
├── 4112064224_report.pdf
├── gpt_conversation.pdf
├── outputs/
...
若上傳 GitHub 或 Colab，需另外提供連結，並在 `README.md` 中整理流程與成果。
